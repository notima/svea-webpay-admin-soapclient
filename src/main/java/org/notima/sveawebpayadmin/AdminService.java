 ...
 * 2021-10-13T15:00:05.761+02:00
 * Generated source version: 3.3.1
 *
 */
@WebServiceClient(name = "AdminService",
                  wsdlLocation = "AdminService.210928.wsdl",
...
public class AdminService extends Service {
    ...
    static {
        URL url = AdminService.class.getResource("AdminService.210928.wsdl");
        if (url == null) {
        	url = AdminService.class.getClassLoader().getResource("AdminService.210928.wsdl");
        }
        if (url == null) { 
            java.util.logging.Logger.getLogger(AdminService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "AdminService.210928.wsdl");
        }
        WSDL_LOCATION = url;
    }
