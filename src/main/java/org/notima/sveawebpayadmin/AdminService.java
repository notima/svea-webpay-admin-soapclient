 ...
 * 2018-11-19T14:22:14.728+01:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "AdminService",
                  wsdlLocation = "AdminService.181119.wsdl",
...
public class AdminService extends Service {
    ...
    static {
        URL url = AdminService.class.getResource("AdminService.181119.wsdl");
        if (url == null) {
            url = AdminService.class.getClassLoader().getResource("AdminService.181119.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(AdminService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "AdminService.181119.wsdl");
        }       
        WSDL_LOCATION = url;    }
